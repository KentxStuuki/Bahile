<!-- INTRO SECTION -->
<div class="intro_section text-white text-center bg-primary py-5 h-auto pb-5">
    <div class="container pb-4">
        <!-- Heading -->
        <h1 class="fs-1 pt-3 pb-3" data-aos="fade-up" data-aos-duration="1000">Bahile Dreamland Estates</h1>

        <!-- Paragraph -->
        <p class="fs-5 lh-base mx-auto px-3" style="max-width: 800px;" data-aos="fade-up" data-aos-duration="1500">
            Bahile Dreamland Estates is a premier residential community designed to provide a harmonious blend of modern living and natural surroundings. Nestled in a peaceful environment, the estate offers a safe, accessible, and sustainable neighborhood that supports families, investors, and individuals seeking long-term value. With carefully planned spaces, landscaped areas, and essential amenities, Bahile Dreamland Estates is your gateway to comfortable and secure living.
        </p>

        <!-- Search Bar -->
        <div class="searchbar d-flex justify-content-center py-4 px-3 mb-2">
            <div class="position-relative w-100" style="max-width: 670px;" data-aos="fade-up" data-aos-duration="2000">
    ...
    <div class="icon-row-wrapper position-relative pt-5">
        <div class="container-fluid position-absolute top-50 start-50 translate-middle custom-container" style="z-index: 10;">
            <div class="row text-primary">
                ...
                <div class="col-md-2 text-center" data-aos="fade-up" data-aos-duration="2000">
...
<div class="text-center text-primary" data-aos="fade-up" data-aos-duration="1000">
    <p class="text-separator">"Where Nature Meets Modern Living"</p>
</div>
