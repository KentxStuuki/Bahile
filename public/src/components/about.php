<div class="about_section d-flex justify-content-center align-items-center mt-2">
    <div class="text-primary text-center fs-1 bg-white py-2 px-5 rounded-pill">About Us</div>
</div>
